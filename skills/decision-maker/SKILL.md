...
name: decision-maker
description: |
  Helps make high-quality decisions using proven frameworks from top experts.
  Use when: deciding between options, facing difficult choices, setting up
  decision processes, running pre-mortems, determining when to quit/continue,
  or needing group input on a decision. Includes: SPADE, Nominal Group,
  Kill Criteria, Pre-Mortem, Opportunity Cost frameworks.
...
**Key Insight**: Most decision delays come from unclear ownership and insufficient exploration of alternatives.
...
**Key Insight**: The only thing that should happen in a meeting is discussion—discovery and decisions should happen independently.
...
**Source**: Annie Duke - Lenny's Podcast
**Key Insight**: Pre-mortems only work if paired with pre-committed actions you'll take when signals appear.
...
**Key Insight**: Imagining failure before it happens surfaces risks that optimism blinds us to.
...
**Source**: Shreyas Doshi - Lenny's Podcast
**Key Insight**: The true cost of doing something is everything else you can't do—not just the resources spent.
...
**Step 3: Compare Against Best Alternative**
Don't ask: "Is this worth doing?"
Ask: "Is this MORE worth doing than the best alternative?"
